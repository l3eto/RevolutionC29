$( document ).ready(function() {
  ...
  if( events.length > 0 ){
    for (var i = 0; i < events.length; i++) { 
      ...
      BUTTON.setAttribute("href",events[i].getElementsByTagName("facebook")[0].textContent);
      ...
      BUTTON.setAttribute("href",events[i].getElementsByTagName("instagram")[0].textContent);
      BUTTON.setAttribute("target","_blank");
      var ICON = document.createElement('I');
